...
@Component({
	...
	template: `
		...
		@if (showCloseButton()) {
			<button hlmBtn variant="ghost" size="icon-sm" class="bg-secondary absolute end-4 top-4" hlmDialogClose>
